...
class TestDocument(unittest.TestCase):
    ...
    def test_get_all_sentences_returns_data(self):
        ...
        expected_results = [
            ...
            {
                'sentence': '一是费力，费体力，每天一大清早就得起来，特别是北邮的占座形势，尤其需要体力强一些，弱柳扶风的小女孩们千万别拿自己的娇躯开玩笑，和那些蹿得比兔子还快的男生们抢座位。',
                'emotion_labals':
            ...
            {
                'sentence': '一天十多小时的复习也需要健健康康的身体来支撑，否则万一晕倒在自习室里可就不妙了。',
                'emotion_labals': 
                    {'Joy': 0.0, 'Hate': 0.0, 'Love': 0.0, 'Sorrow': 0.0, 'Anxiety': 0.5, 'Surprise': 0.0, 'Anger': 0.0, 'Expect': 0.0},
                'length': 40,
                'polarity': '消极'}
