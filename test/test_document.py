...
class TestDocument(unittest.TestCase):
    ...
    def test_get_all_sentences_returns_data(self):
        ...
        all_sentences = self.document.get_all_sentence_data(self.document.root)
    ...
    def test_get_all_paragraphs_return_data(self):
        all_paragraphs = self.document.get_all_paragraph_data()
        ...
        self.assertEqual(all_paragraphs, expected_results)
